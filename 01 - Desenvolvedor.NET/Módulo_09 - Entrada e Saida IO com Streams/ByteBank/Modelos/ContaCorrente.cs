...
namespace ByteBank
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        // Compara a mesma instância
        public int CompareTo(object obj)
        {
            // Verifica se um numero deve ficar na frente do outro, ou se são
            // equivalentes, e assim por diante
            ...
            // Se a referência for nula, ficará no final
            if(outraConta == null)
            {
                return -1;
            }
            ...
            // Else Numero é maior que o da outra conta
            return 1;
